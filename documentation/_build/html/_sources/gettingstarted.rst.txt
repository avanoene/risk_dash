...
since inception, but let's look at historic returns. We can call
``portfolio.quick_plot`` to look at a ``matplotlib`` generated
cumulative return series of the portfolio. If you wanted more control
over plotting, you could use the returned
